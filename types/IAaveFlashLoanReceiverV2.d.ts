...
interface IAaveFlashLoanReceiverV2Interface extends ethers.utils.Interface {
  functions: {
...
export class IAaveFlashLoanReceiverV2 extends Contract {
  ...
  interface: IAaveFlashLoanReceiverV2Interface;

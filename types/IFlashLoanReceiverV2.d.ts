...
interface IFlashLoanReceiverV2Interface extends ethers.utils.Interface {
  functions: {
...
export class IFlashLoanReceiverV2 extends Contract {
  ...
  interface: IFlashLoanReceiverV2Interface;

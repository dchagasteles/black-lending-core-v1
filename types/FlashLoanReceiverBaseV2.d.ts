...
interface FlashLoanReceiverBaseV2Interface extends ethers.utils.Interface {
  functions: {
...
export class FlashLoanReceiverBaseV2 extends Contract {
  ...
  interface: FlashLoanReceiverBaseV2Interface;

...
const deployRewardDistributorManager: DeployFunction = async function (
  ...
  if (process.env.WITH_PROXY)
    await deployAndInitUUPSProxy(ContractId.RewardDistributorManagerProxy, managerTx.address);
};
